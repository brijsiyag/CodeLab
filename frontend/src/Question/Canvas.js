...
const Canvas = () => {
  React.useEffect(() => {
      ...
      if (!isPencil) {
        if (shape === "rect") {
          ...
          ctx.strokeRect(
            shapeInitial.x,
            shapeInitial.y,
            e.offsetX - shapeInitial.x,
            e.offsetY - shapeInitial.y
          );
          ctx.stroke();
          ctx.closePath();
          ctx.beginPath();
          ...
          let radius =
            Math.pow(
              Math.pow(e.offsetX - shapeInitial.x, 2) +
                Math.pow(e.offsetY - shapeInitial.y, 2),
              0.5
            ) / 2;
          ctx.beginPath();
          ctx.arc(
            shapeInitial.x + (e.offsetX - shapeInitial.x) / 2,
            shapeInitial.y + (e.offsetY - shapeInitial.y) / 2,
            radius,
            0,
            Math.PI * 2
          );
    ...
    document
      .querySelector(".line-large-container")
      .addEventListener("click", () => {
        pencilSize = 7;
        prePencilSize = 7;
      });
    document
      .querySelector(".line-medium-container")
      .addEventListener("click", () => {
        pencilSize = 5;
        prePencilSize = 5;
      });
    document
      .querySelector(".line-small-container")
      .addEventListener("click", () => {
        pencilSize = 3;
        prePencilSize = 3;
      });
    document
      .querySelector(".color-black-container")
      .addEventListener("click", () => {
        pencilColor = "black";
        prePencilColor = "black";
        document.querySelector(".selected").style.boxShadow =
          "black 0 0 0px 7px";
        document.querySelector(".selected").style.backgroundColor = "black";
      });
    document
      .querySelector(".color-red-container")
      .addEventListener("click", () => {
        prePencilColor = "red";
        pencilColor = "red";
    ...
    document
      .querySelector(".color-green-container")
      .addEventListener("click", () => {
    ...
    document
      .querySelector(".shape-rect-container")
      .addEventListener("click", () => {
        isPencil = false;
        shape = "rect";
        pencilSize = prePencilSize;
    ...
    document
      .querySelector(".shape-circle-container")
      .addEventListener("click", () => {
        isPencil = false;
        shape = "circle";
        pencilSize = prePencilSize;
    ...
    document
      .querySelector(".shape-line-container")
      .addEventListener("click", () => {
        isPencil = false;
        shape = "line";
        pencilSize = prePencilSize;
    ...
    <div className="canvas-main-container">
      <div className="canvas-controls-container">
        ...
        <div>
          <div>
            <i
              className="fas fa-pencil-alt pencil selected"
